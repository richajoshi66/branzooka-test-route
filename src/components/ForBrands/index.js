                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className=" triangle-banner-content">
                                <h1>For Brands - Reach the Right Audiences on Primetime TV</h1>
                                <p>Brands and businesses worldwide are discovering the power of reaching new audiences through digital placements on Connected TV with Brandzooka. It’s the power of digital with the magic of programmatic built in.</p>
                    ...
                    <div className="left">
                        <div className="overlay">
                            <div className="text-content">
                                ...
                                <p>Brandzooka delivers your business the opportunity to reach existing and new customers by delivering your message on TV and the worlds best sites. It's time to level up your business. </p>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-5">
                            <div className="platform-text">
                              <h5 className="mb-3">WHAT OUR BUSINESS CLIENTS ARE SAYING</h5>
                            </div>  
                            <div className="reviews-slider">
                                <Slider {...settingsReview}>
                                    ...
                                    <div>
                                       <h4>"I have been using Brandzooka for 2 days and I am amazed with the response I am getting. Thanks Brandzooka."</h4>
                                        <p>- Eugene H.</p>
                                    </div>
                                    <div>
                                       <h4>"Brandzooka's analytics help us to see all the places our audience goes"</h4>
                                        <p>- Mike P.</p>
                                    </div>
                                    <div>
                                       <h4>"Brandzooka has created an amazing platform that users of any skill level can easily understand and utilize to promoting their content."</h4>
                                        <p>- Ray C.</p>
                                    </div>
                                </Slider>
                            </div>
